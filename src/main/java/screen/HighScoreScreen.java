...
public class HighScoreScreen extends Screen {
    ...
    public HighScoreScreen(final int width, final int height, final int fps) {
        ...
        try {
            ...
            if (this.highScores2P.size() > 7) {
                this.highScores2P = this.highScores2P.subList(0, 7);
            }
    ...
    private void draw() {
        ...
        drawManager.getHighScoreScreenRenderer()
            .drawHighScoreMenu(drawManager.getBackBufferGraphics(), this);
        drawManager.getHighScoreScreenRenderer()
            .drawHighScores(drawManager.getBackBufferGraphics(), this, getPlayerScores("1P"),
                "1P"); // Left column
        drawManager.getHighScoreScreenRenderer()
            .drawHighScores(drawManager.getBackBufferGraphics(), this, getPlayerScores("2P"),
                "2P"); // Right column
