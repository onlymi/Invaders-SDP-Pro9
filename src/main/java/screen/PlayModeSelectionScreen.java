...
public class PlayModeSelectionScreen extends Screen {
    ...
    protected final void update() {
        ...
        if (this.selectionCooldown.checkFinished() && this.inputDelay.checkFinished()) {
            ...
            if (inputManager.isMouseClicked()) {
                ...
                Rectangle[] modeBoxes = Core.getHitboxManager()
                    .getPlayModeSelectionMenuHitboxes(drawManager.getBackBufferGraphics(), this);
                Rectangle[] allBoxes = {
                    modeBoxes[0], // 1P
                    modeBoxes[1],  // 2P
                    backBox      // Back
    ...
    private void draw() {
        ...
        drawManager.getPlayModeSelectionScreenRenderer()
            .drawPlayModeSelectionMenu(drawManager.getBackBufferGraphics(), this,
                this.menuIndex == 2 ? -1 : this.menuIndex, this.menuIndex);
        drawManager.getCommonRenderer()
            .drawBackButton(drawManager.getBackBufferGraphics(), this, this.menuIndex == 2);
