...
import static engine.gameplay.item.ItemEffect.ItemEffectType;
...
public class Ship extends Entity {
    ...
    private static final int BASE_BULLET_SPEED = -40;
    private static final int BASE_SHOOTING_INTERVAL = 70;
