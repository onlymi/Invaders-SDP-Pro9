...
public class PlayModeSelectionScreenRenderer {
     ...
     */
    public void drawPlayModeSelectionMenu(Graphics g, final Screen screen,
        ...
        for (int i = 0; i < items.length; i++) {
            ...
            commonRenderer.drawCenteredRegularString(g, screen, items[i],
                baseY + fontMetrics.getHeight() * 3 * i);
        }
    }
}
